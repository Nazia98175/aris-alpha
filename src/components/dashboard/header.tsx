...
import { useRouter } from 'next/navigation' // ✅ now this will work
                            ...
                            {userDropdownOpen && (
                                <div className="ring-opacity-5 absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-lg border border-white/[7%] bg-[#1a1a1a] shadow-lg ring-1 shadow-black/50 ring-black focus:outline-none">
                                    <div className="py-1">
                                        ...
                                        <Link
                                            href="/profile"
                                            className="text-grey block px-4 py-2 text-sm transition-colors hover:bg-white/[5%] hover:text-white"
                                        ...
                                        <div className="mt-1 border-t border-white/[7%]">
                                            <button
