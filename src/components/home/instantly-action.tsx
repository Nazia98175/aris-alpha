        ...
        <section className="custom-container relative w-full">
            <div className="relative mx-auto max-w-[600px] overflow-hidden rounded-2xl border border-[#808080] bg-[#FCF6F1] p-4 shadow-[0px_16px_80px_0px_rgba(102,77,255,0.10)] sm:p-[40px] md:rounded-[22px] md:p-[22px] lg:max-w-full lg:p-[64px]">
                <div className="flex flex-col-reverse items-center justify-between gap-7 lg:flex-row">
                    <div className="w-full md:max-w-[623px]">
                        ...
                        <button className="flex h-[45px] w-full max-w-[170px] cursor-pointer items-center justify-center rounded-[40px] bg-[#2A64F6] text-base text-white shadow-[0px_0px_10px_0px_rgba(119,68,255,0.70)] transition-all duration-300 hover:scale-95 md:h-[63px]">
                            Get started
                        </button>
                    </div>
                    <div className="static top-[50%] w-full max-w-[600px] transform lg:absolute lg:right-[-23%] lg:-translate-y-1/2 xl:right-[-34%] xl:max-w-[767px]">
                        <Image
                            width={500}
                            height={500}
