        ...
        <Container className="relative flex flex-col items-center gap-7 text-center sm:gap-10">
            <div className="relative">
                <div className="relative z-10 space-y-5" id="subscribe">
                    <h2 className="text-3xl font-medium sm:text-7xl">Stay Ahead of the Market</h2>
                    <p className="text-muted-foreground max-w-5xl text-sm sm:text-base">
                        Get timely trading insights, market sentiment, and strategic signals—delivered straight to your
                        inbox.
                    </p>
                </div>
            ...
            <Form {...form}>
                <div className="flex w-full max-w-3xl flex-col gap-4 overflow-hidden rounded-xl border border-white/10 bg-white/5 px-5 py-3 sm:flex-row sm:px-10 sm:py-7">
                    <div className="flex flex-1 items-center gap-4">
                        <FormInput
                            ...
                            placeholder="Enter your email to receive real-time signal breakdowns and outlooks."
                        />
                    </div>
                    <LoadingButton
                        variant="vibrant"
