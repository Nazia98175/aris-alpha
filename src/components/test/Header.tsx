...
export const Header = () => {
    ...
    return (
        <header className="bg-darkblack relative border-b border-white/[7%] px-4 py-3 lg:px-6">
            ...
            <div
                ref={searchRef}
                className={`bg-darkblack absolute top-full left-0 z-20 w-full transform px-4 py-3 transition-all duration-300 ease-in-out lg:hidden ${
            ...
            <div className="flex flex-nowrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4 whitespace-nowrap xl:gap-6">
                    ...
                    <div className="bg-lightgrey hidden h-[15.03px] w-px xl:block" />
