    ...
    return (
        <section className="mx-auto flex w-full max-w-[1140px] flex-col items-center justify-center gap-5 px-4 py-10 text-white md:gap-[51px] lg:flex-row lg:py-20 xl:px-0">
            ...
            <div className="w-full max-w-full lg:max-w-[433px]">
                ...
                <div className="mb-3 w-full max-w-[433px] cursor-pointer rounded-[16px] bg-white/[8%] px-5 py-3 text-left text-sm text-white backdrop-blur-[32px] md:mb-6 md:text-base">
