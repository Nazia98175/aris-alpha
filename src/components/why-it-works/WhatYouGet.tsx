...
const WhatYouGet = () => {
    return (
        <section className="mx-auto flex w-full max-w-[1140px] flex-col items-center justify-center px-4 py-10 lg:py-20 xl:px-0">
            ...
            <div className="grid max-w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                {whatYouGet.map((item, idx) => (
                    ...
                    >
                        ...
                        <span className="absolute top-0 left-0 h-[3px] w-full scale-x-0 bg-gradient-to-r from-[#2A64F633] via-[#2A64F633] to-[#2A64F633] transition-all duration-300 group-hover:scale-x-100 md:rounded-t-[30px]" />
                        <span className="absolute bottom-0 left-0 h-[3px] w-full scale-x-0 bg-gradient-to-r from-[#2A64F633] via-[#2A64F633] to-[#2A64F633] transition-all duration-300 group-hover:scale-x-100 md:rounded-b-[30px]" />
