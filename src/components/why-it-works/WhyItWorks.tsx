...
const WhyItWorks = () => {
    return (
        <section className="relative flex h-auto flex-col items-center justify-center bg-[url('/assets/backgrounds/working-bg.webp')] bg-cover bg-center px-6 py-10 text-white md:h-[493px] md:py-20 xl:px-0">
