            ...
            <div className="mx-auto w-full max-w-[1140px]">
                <div className="bg-howlblack relative h-auto rounded-[15px] border px-0 pt-4 backdrop-blur-[33.3px] md:rounded-[32px] md:pt-6 xl:h-[586px]">
                    <div className="relative z-10 px-2 md:px-4 xl:px-0">
                        ...
                        <p className="description !text-waterwhite/[80%] mx-auto mt-2 max-w-[830px] !text-center md:mt-4">
                    ...
                    <Image
                        ...
                        width={1139}
                        height={487}
                        className="relative top-0 z-0 h-auto w-full rounded-[15px] md:rounded-[32px] xl:-top-20"
                        priority
                    />
                </div>
            </div>
