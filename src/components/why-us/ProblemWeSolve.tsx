...
const ProblemWeSolve = () => {
    return (
        <section className="w-full px-6 py-10 text-white md:py-20 xl:px-0">
            <div className="mx-auto flex h-auto w-full max-w-[1140px] flex-col items-center justify-between lg:h-[450px] lg:flex-row">
                {/* Text Column */}
                <div className="font-poppins w-full max-w-full lg:max-w-[542px]">
                    <h2 className="secondary-heading mb-6">The Problem We Solve</h2>
                    <p className="description mb-6 !text-waterwhite/[80%]">
                    ...
                    <p className="description !text-waterwhite/[80%]">
                ...
                <Image
                    ...
                    width={800.84}
                    height={100}
                    className="block h-fit lg:hidden"
                />
            </div>
        </section>
    )
