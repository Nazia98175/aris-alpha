...
const WhoAreWe = () => {
    return (
        <section className="relative flex h-auto flex-col items-center justify-center bg-[url('/assets/homepage/png/working-another-bg.png')] bg-cover bg-center px-4 py-10 text-white lg:h-[493px] lg:py-20 xl:px-0">
